...
import type { Loading as _Loading } from 'quasar'
import {
...
function note(action, loadingDefaults: any) {
  return Notify[action](loadingDefaults)
}
...
function config(arg0: boolean, config: any) {
