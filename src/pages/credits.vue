<template>
  <div class="q-pa-sm responsive">
    <h1 class="text-h4 text-center">Used Technologies</h1>
    <div class="flex flex-row justify-center">
      <div v-for="(sponsor, index) in sponsors" :key="index" class="block flex-initial quasar-sponsor" flat bordered @click.native="openWebsite(sponsor.url)" :style="style">
        <div class="quasar-sponsor__title text-center">
          {{ sponsor.name }}
          <q-separator />
          <div class="quasar-sponsor__logo flex flex-center">
            <q-img :alt="sponsor.name" :src="sponsor.img" :ratio="1" />
          </div>
        </div>
      </div>
    </div>
