  ...
  <div class="q-pa-sm responsive">
    ...
    <div class="row q-gutter-sm justify-center">
      <q-card
        ...
        :key="index"
        class="quasar-sponsor"
        flat
        bordered
        @click.native="openWebsite(sponsor.url)"
        :style="style"
      >
        <q-card-section class="quasar-sponsor__title text-center">
          {{ sponsor.name }}
          <q-separator />
          <q-card-section class="quasar-sponsor__logo flex flex-center">
