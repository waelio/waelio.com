---
title: Waelio | Terms & Conditions
---
<q-page padding>

  <h1 class="text-h2"><strong>Terms and Conditions</strong></h1>

  <p class="text-justify">Welcome to Waelio.com!</p>

  <p class="text-justify">
    These terms and conditions outline the rules and regulations for the use
    of Waelio.com's Website, located at https://waelio.com.
  </p>

  <p class="text-justify">
    By accessing this website we assume you accept these terms and conditions.
    Do not continue to use Waelio.com if you do not agree to take all of the
  ...
  <p class="text-justify">
    We employ the use of cookies. By accessing Waelio.com, you agreed to use
    cookies in agreement with the Waelio.com's Privacy Policy.
  </p>
  ...
  <p class="text-justify">
    Unless otherwise stated, Waelio.com and/or its licensors own the
    intellectual property rights for all material on Waelio.com. All
    intellectual property rights are reserved. You may access this from Wael
    Wahbeh for your own personal use subjected to restrictions set in these
    terms and conditions.
  </p>

  <p class="text-justify">You must not:</p>
  <ul>
    <li>Republish material from Waelio.com</li>
    <li>Sell, rent or sub-license material from Waelio.com</li>
    <li>Reproduce, duplicate or copy material from Waelio.com</li>
    <li>Redistribute content from Waelio.com</li>
  </ul>
  ...
  <p class="text-justify">
    ...
    opinions and information in certain areas of the website. Waelio.com does
    not filter, edit, publish or review Comments prior to their presence on
    the website. Comments do not reflect the views and opinions of Wael
    Wahbeh,its agents and/or affiliates. Comments reflect the views and
    opinions of the person who post their views and opinions. To the extent
    permitted by applicable laws, Waelio.com shall not be liable for the
  ...
  <p class="text-justify">
    Waelio.com reserves the right to monitor all Comments and to remove any
  ...
  <p class="text-justify">
    You hereby grant Waelio.com a non-exclusive license to use, reproduce,
  ...
  <p class="text-justify">
    ...
    hyperlink compensates the absence of Waelio.com; and (d) the link is in
  ...
  <p class="text-justify">
    ...
    e-mail to Waelio.com. Please include your name, your organization name,
  ...
  <p class="text-justify">
    No use of Waelio.com's logo or other artwork will be allowed for linking
