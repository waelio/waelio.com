...
<template>
  <nav class="text-xl mb-6">
    ...
    |    
    <router-link class="icon-btn mx-2 text-sm" to="/about" :title="t('button.about')">
      {{t('button.about')}}
    </router-link>
    |
    <router-link class="icon-btn mx-2 text-sm" to="/contact" :title="t('button.Contact')">
      {{t('button.Contact')}}
    </router-link>
|
...
|
    <router-link class="icon-btn mx-2 text-sm" to="/about" :title="t('button.TimeLine')">
      {{t('button.TimeLine')}}
    </router-link>
  </nav>
</template>
